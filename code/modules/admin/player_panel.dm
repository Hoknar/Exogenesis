...
/datum/admins/proc/check_antagonists()
	if (ticker && ticker.current_state >= GAME_STATE_PLAYING)
		...
		if(ticker.mode.borers.len)
			dat += "<br><table cellspacing=5><tr><td><B>Borers</B></td><td></td></tr>"
			for(var/datum/mind/N in ticker.mode.borers)
				var/mob/M = N.current
				if(M)
					dat += "<tr><td><a href='?src=\ref[src];adminplayeropts=\ref[M]'>[M.real_name]</a><i>([M.key])</i> [M.client ? "" : " <i>(logged out)</i>"][M.stat == 2 ? " <b><font color=red>(DEAD)</font></b>" : ""]</td>"
					dat += "<td><A href='?src=\ref[usr];priv_msg=\ref[M]'>PM</A></td></tr>"
			dat += "</table>"

		if(ticker.mode.aliens.len)
			dat += "<br><table cellspacing=5><tr><td><B>Aliens</B></td><td></td></tr>"
			for(var/datum/mind/N in ticker.mode.aliens)
				var/mob/M = N.current
				if(M)
					dat += "<tr><td><a href='?src=\ref[src];adminplayeropts=\ref[M]'>[M.real_name]</a>[M.client ? "" : " <i>(logged out)</i>"][M.stat == 2 ? " <b><font color=red>(DEAD)</font></b>" : ""]</td>"
					dat += "<td><A href='?src=\ref[usr];priv_msg=\ref[M]'>PM</A></td></tr>"
