/mob/living/simple_animal/captive_brain
	name = "host brain"
	real_name = "host brain"

/mob/living/thrall_tent
	name = "Thrall Tentacle"
	real_name = "thrall tentacle"

/mob/living/simple_animal/captive_brain/say(var/message)
...
/mob/living/simple_animal/captive_brain/emote(var/message)
	return
...
/mob/living/simple_animal/borer
	...
	var/mob/living/simple_animal/captive_brain/host_brain // Used for swapping control of the body back and forth.
...
/mob/living/simple_animal/borer/New()
	...
	host_brain = new/mob/living/simple_animal/captive_brain(src)
...
/mob/living/simple_animal/borer/verb/dominate_victim()
	...
	if(M.has_brain_worms())
		src << "You cannot dominate someone who is already infested!"
		return
...
//			ticker.mode.update_borer_icons_added(hostmind) //Add Borer HUD

			host_brain.ckey = host.ckey
			host.ckey = src.ckey
			controlling = 1
			ticker.mode.update_all_borer_icons() //Add HUD
			host.verbs += /mob/living/carbon/proc/release_control
			host.verbs += /mob/living/carbon/proc/punish_host
			host.verbs += /mob/living/carbon/proc/spawn_larvae
			host.verbs += /mob/living/carbon/proc/thrall_tent
...
mob/living/simple_animal/borer/proc/detatch()
	...
	var/datum/mind/hostmind = host.mind
	if (hostmind.special_role != "Borer")
		ticker.mode.borers -= hostmind
	...
	ticker.mode.brains -= host_brain
	host = null

	ticker.mode.update_all_borer_icons() //Remove HUD
...
/mob/living/simple_animal/borer/verb/infest()
	...
	if(M in view(1, src))
		...
		var/datum/mind/hostmind = M.mind
		ticker.mode.borers += hostmind
		ticker.mode.brains += host_brain
		ticker.mode.update_all_borer_icons() //Add HUD
...
mob/living/simple_animal/borer/proc/transfer_personality(var/client/candidate)
	...
	if(src.mind)
		...
		src.mind.special_role = "Borer"
		ticker.mode.greet_borer(src.mind)
		ticker.mode.borers += src.mind
		ticker.mode.update_borer_icons_added(src.mind)

mob/living/simple_animal/borer/verb/ThrallConvert()
	set name = "Convert to Thrall"
	set desc = "Attempt to convert your humanoid host."
	set category = "Alien"
	...
	if(host.mind.special_role == "Borer")
		src << "They are already a Thrall."
		return
	...
	if(world.time < host.mind.rev_cooldown)
		src << "\red Wait a minute before reconversion attempt."
		return

	src << "\red Attempting to convert [host]..."
	log_admin("[src]([src.ckey]) attempted to convert [host].")
	message_admins("\red [src]([src.ckey]) attempted to convert [host].")

	var/ntent = host.num_thrall_tent()
	var/choice = "No!"

	if(ntent < 1)
		choice = alert(host,"You feel a question coming to your mind. You feel like whatever you decide will be binding in some way: Do you want to join the aliens?","Work with them?","No!","Yes!")
	else if (ntent < 2)
		choice = alert(host,"You feel a question coming to your mind. You feel like whatever you decide will be binding in some way. For some reason you think it is a good idea to say Yes!: Do you want to join the aliens?","Work with them?","No!","Yes!")
	else if (ntent < 3)
		choice = alert(host,"You feel a question coming to your mind. You feel like whatever you decide will be binding in some way: You think it is a good idea and find it very hard to resist. Do you want to join the aliens?","Work with them?","No!","Yes!")
	else if (ntent < 4)
		choice = alert(host,"You feel a question coming to your mind. You want more than anything to say 'Yes!'. You love the aliens!: Do you want to join the aliens?","Work with them?","No!","Yes!")
	else
		choice = "Yes!"
		host << "\red You cannot resist anymore! You willingly agree to serve your alien masters!"

	if(choice == "Yes!")
		ticker.mode.convert_thrall(host.mind)
		host << "\blue You become a Borer Thrall!"
		src << "\blue <b>[host] becomes a Borer Thrall!</b>"
	else if(choice == "No!")
		host << "\red You reject this strange alien!"
		src << "\red <b>[host] rejects your attempt to enthrall them!</b>"
	host.mind.rev_cooldown = world.time+500