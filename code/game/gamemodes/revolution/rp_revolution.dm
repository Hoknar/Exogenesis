	...
	for(var/datum/mind/rev_mind in head_revolutionaries)
		if(!config.objectives_disabled)
			for(var/datum/mind/head_mind in heads)
				...
				rev_obj.explanation_text = "Convert or capture [head_mind.name], the [head_mind.assigned_role]."
...
/datum/game_mode/revolution/rp_revolution/greet_revolutionary(var/datum/mind/rev_mind, var/you_are=1)
	...
	if(!config.objectives_disabled)
		for(var/datum/objective/objective in rev_mind.objectives)
			...
			obj_count++
		rev_mind.current << "\red Only kill anyone as a last resort! Even those who will not be converted we will need as hostages against NT!"
	else
...
/datum/game_mode/revolution/rp_revolution/latespawn(mob/M)
	if(M.mind.assigned_role in command_positions)
		...
		for(var/datum/mind/rev_mind in head_revolutionaries)
			...
			rev_obj.explanation_text = "Convert or capture [M.real_name], the [M.mind.assigned_role]."
			rev_mind.objectives += rev_obj
